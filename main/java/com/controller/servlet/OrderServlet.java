...
//    	System.out.println(object);
        ...
        try {
            ...
            try (Transport tt = session.getTransport()) {
                ...
                new_order.setBookId(Integer.parseInt(object.get("bookid").getAsString()));
                ...
                new_order.setTotalAmount(BigDecimal.valueOf(Integer.parseInt(object.get("price").toString())));
